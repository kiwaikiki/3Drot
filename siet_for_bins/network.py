...
class Network_GS(torch.nn.Module):
    def __init__(self, backbone='resnet18'):
        ...
        self.fc_z = torch.nn.Linear(last_feat, 3)
        self.fc_y = torch.nn.Linear(last_feat, 3)
        # self.fc_t = torch.nn.Linear(last_feat, 3)
...
class Network_Axis_Angle_4D(torch.nn.Module):
    def __init__(self, backbone='resnet18'):
        ...
        self.axis = torch.nn.Linear(last_feat, 3)
        self.angle = torch.nn.Linear(last_feat, 1)
        # self.t = torch.nn.Linear(last_feat, 3)
...
class Network_Stereographic(torch.nn.Module):
    def __init__(self, backbone='resnet18'):
        ...
        self.stereo = torch.nn.Linear(last_feat, 5)
        # self.t = torch.nn.Linear(last_feat, 3)
